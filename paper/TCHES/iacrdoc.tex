...
\paragraph{\texttt{[nohyperxmp]}}
disables the automatic loading of \texttt{hyperxmp}.
The \texttt{iacrtrans} class has issues with \texttt{hyperxmp}
versions betwen 5.0 and 5.4, use this option to disable loading it.
...
\item[v 0.93] Fixed bug with affiliation footnote numbering for more than 10 affiliations.
\item[v 0.94] Fixed hyperxmp issues (new issues with version 5.12).
              Added new class option \texttt{nohyperxmp}.
\end{description}
